...
def main():
    ...
    while not window_should_close():
        ...
        if order:
            ...
            draw_text("Model: " + models[selected_model], 10, 10-int(scroll_y) , 15, LIGHTGRAY);
            ...
            draw_text(msg, int(window_width/2 - measure_text(msg, 30)/2), int(window_height/2-30), 30, LIGHTGRAY);
        end_drawing()
